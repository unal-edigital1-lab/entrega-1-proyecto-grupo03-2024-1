...
En cuento a la forma de operación del dispositivo, inicialmente se contaran con 8 estados, los cuales son:
  ...
  - **Jugar**: En este estado el usuario puede elegir/iniciar alguno de los juegos disponibles, esto con el objetivo de eliminar el indicador respectivo mediante un incremento en el nivel de diversión de su mascota. 
